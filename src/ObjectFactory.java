public class ObjectFactory {
    ...
    public Graph robot2(){
        Node a = new Node("a", -1,0,1);
        Node b = new Node("b", 0,-1,1);
        Node c = new Node("c", 1,0,1);
        Node d = new Node("d", -1,0,1);
        Node e = new Node("e", -1,0,0);
        Node f = new Node("f", 0,-1,0);
        Node g = new Node("g", 1,0,0);
        Node h = new Node("h", -1,0,0);
        //Create a graph structure representing a robot
        Graph graph = new Graph(this.robot_type);
        //Add some mass to them
        a.addMass(1);
